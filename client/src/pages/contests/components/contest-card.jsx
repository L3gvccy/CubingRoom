...
const ContestCard = ({ event, id }) => {
  ...
  return (
    <div
      ...
      className=" py-6 w-28 md:w-42 flex flex-col gap-4 justify-center rounded-xl group bg-size-[200%_200%] ease-out bg-linear-to-br from-violet-600 via-violet-500 to-violet-700 cursor-pointer hover:bg-position-[100%_100%] transition-all duration-500"
    >
      <img
